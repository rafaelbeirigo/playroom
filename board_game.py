...
if __name__ == "__main__":
    ...
    blue_block = tk.PhotoImage(file="/home/rafaelbeirigo/ciencia/playroom/img/blue_block.gif")
    red_block = tk.PhotoImage(file="/home/rafaelbeirigo/ciencia/playroom/img/red_block.gif")
    ...
    board.addpiece("blue_block", blue_block, 0,4)
    board.addpiece("red_block", red_block, 1,0)
